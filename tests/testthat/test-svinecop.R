...
test_that("fitting models (1d)", {
  u <- runif(100)
  sv <- svinecop(u, p = 0)
  expect_length(svinecop_sim(10, sv), 10)
  expect_length(svinecop_sim_ahead(10, u, sv), 10)
  expect_length(svinecop_sim_conditional(10, u, sv), 10)
...
test_that("fitting models (multivariate)", {
  ...
  sv <- svinecop(u, p = 0)
  AIC(sv)
  expect_equal(dim(svinecop_sim(10, sv)), c(10, 2))
  expect_equal(dim(svinecop_sim_ahead(10, u, sv)), c(10, 2))
  expect_equal(dim(svinecop_sim_conditional(10, u, sv)), c(10, 2))
